...
template <> constexpr inline auto ImageWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11ImageWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'clicked'
        QtMocHelpers::SignalData<void(const QPoint &)>(2, 3, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 4, 5 },
        }}),
    };
...
void ImageWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ImageWidget::*)(const QPoint & )>(_a, &ImageWidget::clicked, 0))
            return;
    }
}
...
// SIGNAL 0
void ImageWidget::clicked(const QPoint & _t1)
{
